...
[<a href="/admin/page/ed/edit/<?= $row['id'] ?>/<?= (int)$row['subpage_of'] ?>?&came_from=<?= req_uri_q(true) ?>">Править</a> |
<a href="/admin/page/ed/edit/0/<?= $row['id'] ?>?&came_from=<?= req_uri_q(true) ?>" title="Добавить подстраницу">+</a><?php if($row['id']>100){ ?> | <a href="javascript:void(0)" onclick="if(confirm('Удалить?')){location.href='/admin/page/index/del/?&id=<?= $row['id'] ?>';}else{return false;}">Удалить</a><?php } ?>]
<br>
  <?php } ?>
