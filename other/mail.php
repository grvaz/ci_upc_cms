...
//йцу
    global $config;
    $config['smtp_username'] = 'upc.domains@yandex.ru';  //Смените на имя своего почтового ящика.
    $config['smtp_port']     = 25; // Порт работы. Не меняйте, если не уверены.
    $config['smtp_host']     = 'smtp.yandex.ru';  //сервер для отправки почты
    $config['smtp_password'] = 'f7je49hk45';  //Измените пароль
...
global $send;
smtpmail($send['mail'], $send['title'], $send['mailtext'], $headers='');
